...
class AlternativeDocumentType(BaseModel):
    document_type: str = Field(..., description="Alternative document type name")
...
class DocumentTypeClassification(BaseModel):
    ...
    alternative_types: List[AlternativeDocumentType] = Field(
